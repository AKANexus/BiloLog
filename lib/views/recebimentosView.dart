...
class RecebimentosView extends StatefulWidget {
  ...
  RecebimentosView({Key? key}) : super(key: key);
  static const String routeName = "/recebimentosView";

  @override
  State<RecebimentosView> createState() => _RecebimentosViewState();
}

class _RecebimentosViewState extends State<RecebimentosView> {
